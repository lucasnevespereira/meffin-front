<template>
  <div class="container flex flex-col p-10">
    ...
    <div class="mt-8">
      ...
      <button @click="addCategory('expense')" class="btn btn-sm btn-primary">
        Ajouter Catégorie
      </button>
    </div>
    ...
    <div class="mt-8">
      ...
      <button @click="addCategory('income')" class="btn btn-sm btn-primary">
        Ajouter Catégorie
      </button>
    </div>
  </div>
...
const incomeCategories = categories.value.filter(
